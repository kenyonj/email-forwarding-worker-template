...
0. Any email that you plan on forwarding to has to be added to your cloudflare
   account as a forwarding email address. You can use the "Add Verified Email
   to Cloudflare" action to add one by manually triggering this workflow:
   [add-email-to-cloudflare.yml](.github/workflows/add-email-to-cloudflare.yml)
